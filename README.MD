...
Release 0.1:
	- Initial release. Documentation, tests, instructions and continuous integration.
	- Reader handles 8/16/24/32 bit uncompressed RIFF WAVE files.
	- Reader is non-copyable but moveable into containers.
